...
Generar un nuevo `data.frame` con los datos del Departamento "MARCOS JUAREZ"

```{r}

```

Nota: si quedaron filas con faltantes `NA`, elminarlas. Puede usar `!is.na`



- Crear un vector booleano que indique si aumentó el rinde respecto a la campaña anterior:
